...
df_sample_Brooklyn<-sample_n(dfbrklyn,100)
df_sample_Queens<-sample_n(dfqueens,100)
df_sample_Bronx<-sample_n(dfbronx,100)
df_sample_manhattan<-sample_n(dfmanhattan,100)
df_sample_staten<-sample_n(dfstaten,100)

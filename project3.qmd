...
_load and prepare base data for this markdown file..._
...
## Job status, Organization, and Degree Type 


### Job Status by Degree
...
###  Organization Size related Years Coding 
...
```{r count_of_surveyors, echo=FALSE}

# counts_avg_salaries <- wide_stack %>%
#   filter(rowSums(.[, language_cols] == "yes") <= 1) %>%
#   mutate(KnownLanguage = case_when(
#     python == "yes" ~ "python",
#     sql == "yes" ~ "sql",
